function [Ccost] = covariationCost(VXY, AVD, xtarget, ytarget)
%
%
...
%             if ~VXY,
                ...
                new1 = execution2result_polar_rotation(M(i,1), M(j,2), xtarget, ytarget);
                new2 = execution2result_polar_rotation(M(j,1), M(i,2), xtarget, ytarget);
%             else
